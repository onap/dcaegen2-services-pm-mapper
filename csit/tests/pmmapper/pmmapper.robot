...
${CLI_EXEC_CLI_CONFIG_FIRST_100_LINES}   { grep password;} < /tmp/pmmapper.log
...
Verify that password receive from CBS are successfully encrypted
    ...
    CheckLog                        ${CLI_EXEC_CLI_CONFIG_FIRST_100_LINES}           "aaf_password": *****
    CheckLog                        ${CLI_EXEC_CLI_CONFIG_FIRST_100_LINES}           "password": *****
