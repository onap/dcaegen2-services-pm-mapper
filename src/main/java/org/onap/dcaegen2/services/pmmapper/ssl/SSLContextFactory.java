...
public class SSLContextFactory {
    ...
    public static KeyManager[] createKeyManager(KeyStore keyStore) throws NoSuchAlgorithmException, IOException {
        ...
        try {
            ...
            logger.unwrap().error("Incorrrect password {}", e);
        }
    ...
    public static TrustManager[] createTrustManager(KeyStore trustStore) throws NoSuchAlgorithmException {
    ...
    public static KeyStore loadKeyStore(String path, String passwordPath) throws IOException, NoSuchAlgorithmException {
        String type = "JKS";
        ...
        encodedKeystore = encodedKeystore.replace("\n", "").replace("\r", "");

        byte[] decodedKeystore = Base64.getDecoder().decode(encodedKeystore);
    ...
    private static String getPassword(String passwordPath) throws IOException {
        try {
