...
public class App {
    ...
    public static void main(String[] args) throws InterruptedException, TooManyTriesException, CBSConfigException, EnvironmentConfigException, CBSServerError, MapperConfigException {
        ...
        flux.publishOn(Schedulers.newParallel(""), 1)
                .onBackpressureDrop(App::handleBackPressure)
     ...
     * @param event to be marked as will not process.
     */
     ...
     * @param event to be marked as received.
     */
