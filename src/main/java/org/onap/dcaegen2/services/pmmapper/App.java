...
public class App {
     ...
     */
    public App(Path mappingTemplate, Path xmlSchema, ConfigHandler configHandler) {
        try {
    ...
    public static void main(String[] args) {
        new App(mappingTemplate, xmlSchema, new ConfigHandler()).start();
    }
